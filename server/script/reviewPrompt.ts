...
- Do not flag: faithful paraphrase or translation of a fact, however casually or conversationally worded (a shorter sentence, a rhetorical question, a spoken-language rephrasing of a supported claim is still that claim, not a new one); a clearly framed analogy or metaphor that makes no factual claim; reflection that is plainly marked as interpretation ("that suggests...", "one way to read this is..."); hooks, transitions and connective phrases that assert nothing factual, including a soft editorial link between stories ("in a similar vein", "elsewhere today") that states no shared fact, cause or theme; a claim supported by any research item, even one the plan did not select (that is only "off-plan-evidence").
- "unsupported-claim" and "unsupported-connection" are for a script asserting something as true, or asserting a link between stories, that the evidence does not support — not for the writer's tone, phrasing or sentence rhythm. A natural, engaging way of saying something the evidence already supports is not a new claim. Reserve these for a claim or a link you cannot find any basis for anywhere in the evidence.
